...
<head>
    ...
    <script type="text/javascript" src="./Public/js/sea/sea.js" data-config="./Public/js/sea/config"></script>
</head>
<body>
<div class="all">
    ...
    <div class="header">
        <div class="nav">
            <div class="clearfix">
                <div class="logo"><a href="#"><img src="./Public/images/logo.png" alt="Kelly"></a></div>
                <ul class="nav-list">
                    <li<?php if(($nav == 1)): ?>class="selected"<?php endif; ?> ><a href="#">Home</a></li>
                    <li class="separate">|</li>
                    <li<?php if(($nav == 2)): ?>class="selected"<?php endif; ?>><a href="#">About</a></li>
                    <li class="separate">|</li>
                    <li<?php if(($nav == 3)): ?>class="selected"<?php endif; ?>><a href="#">Work</a></li>
                    <li class="separate">|</li>
                    <li<?php if(($nav == 4)): ?>class="selected"<?php endif; ?>><a href="#">Downloads</a></li>
                    <li class="separate">|</li>
                    <li<?php if(($nav == 5)): ?>class="selected"<?php endif; ?>><a href="#">Contact</a></li>
                    <li class="separate">|</li>
                    <li<?php if(($nav == 6)): ?>class="selected"<?php endif; ?>><a href="#">Guestbook</a></li>
                    <li class="separate">|</li>
                    <li<?php if(($nav == 7)): ?>class="selected"<?php endif; ?>><a href="#">News</a></li>
                </ul>
            </div>
            <?php if(($nav == 2)): ?><div class="sub">
                <div class="sub-inner">
                    <a href="#">Information</a><a href="#">Portfolio</a>
                </div>
            </div><?php endif; ?>
        </div>
    </div>
...
<div class="content">
    <div class="banner" id="newBanner">
        ...
        <img src="./Public/images/banner/04.jpg" alt="">
    </div>
