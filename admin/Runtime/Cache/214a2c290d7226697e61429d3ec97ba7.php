			...
			<div class="blist">
				...
				<div class="itm">
						...
						<tbody>
							...
							<tr>
								...
								<td><span class="input01">
									<input type="text" name="update_date" value="<?php echo ($data[0]["update_date"]); ?>" id="smidate" readOnly="true" >
					...
					<p style="padding-top: 10px">
						...
						<input type="hidden" name="bid" value="<?php echo ($data[0]["bid"]); ?>"/>	
