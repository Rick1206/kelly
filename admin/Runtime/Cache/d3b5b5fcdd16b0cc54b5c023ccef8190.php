...
<body id="index" onload="">
	...
	<div class="content fn-clear">
		...
		<div class="main">
			...
			<div class="blist">
				<div class="tit">
					NewsList <s><a href="__URL__/addnews">Add News</a></s>
				</div>
						...
						<table class="tb-01">
							...
							<tbody>
								<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
										<td>
										<input type="checkbox" name="cho[]" value='<?php echo ($vo["nid"]); ?>'/>
										</td>
										<td> <?php echo ($vo["title_cn"]); ?> | <?php echo ($vo["title_en"]); ?> </td>
										<td><?php echo ($vo["dateline"]); ?></td>
										<td><a href="__URL__/editnews/nid/<?php echo ($vo["nid"]); ?>"><s class="s1"></s></a></td>
