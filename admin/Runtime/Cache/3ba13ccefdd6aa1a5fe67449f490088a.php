...
<body id="index" onload="">
	...
	<div class="content fn-clear">
		<div class="leftmenu">
			...
			<ul>
				<li>
					<a href="__APP__/Downloads/index" class="cus">Downloads<s></s></a>
				</li>
			</ul>
		</div>
		...
		<div class="main">
			...
			<div class="blist">
				...
				<div class="itm">
					<form action="<<?php echo ($url); ?>>/edit" method="post" accept-charset="utf-8" enctype="multipart/form-data">
					<table class="tb-02">
						<thead>
							<tr>
						...
						<tbody>
							...
							<tr>
								...
								<td><span class="input01">
									<input type="text" name="update_data" value="<?php echo ($data[0]["update_date"]); ?>" id="smidate" readOnly="true" >
									<span class="icn1"></span></span></td>
								<td width="60">顺序:</td>
								<td><span class="input01">
									<input type="text" name="gname" value="<?php echo ($data[0]["orderby"]); ?>">
								</span></td>
							</tr>
							<tr>
								<td>分类:</td>
								...
								<td>图片:</td>
								<td><span class="input01">
									<input type="file" name="gthumb" value="<<?php echo ($data[0]["gthumb"]); ?>>">
								...
								<tbody>
									<tr>
										...
										<td><span class="input01" style="width:480px;">
											<input type="text" name=""  style="width:480px;">
										</span></td>
									</tr>
									<tr>
										<td colspan="2">
										<div class="bd">
											<textarea name="edit"></textarea></div>
										</td>
									</tr>
									<tr>
