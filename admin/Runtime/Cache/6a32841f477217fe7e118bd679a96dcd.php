...
<body id="index" onload="">
	...
	<div class="content fn-clear">
		<div class="leftmenu">
			...
			<ul>
				<li>
					<a href="javascript:;" class="cus">Work<s></s>
						<a href="">Work List<s></s></a>
						<a href="">Work Cateroy<s></s></a>
					</a>
				</li>
				<li></li>
				<!-- <li>
					<a href="" class="cus">Work Category<s></s></a>
				</li> -->
			</ul>
		</div>
		<div class="main">
			...
			<div class="blist">
				<div class="tit">
					WorkList <s><a href="__URL__/addWork">Add Work</a></s>
				</div>
